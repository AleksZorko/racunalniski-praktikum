\begin{frame}{Konstrukcija pravokotnice na premico $p$ skozi točko $T$}
		  ...
		  \begin{itemize}[<+->]
			\centering
			 \item Dani sta premica $p$ in točka $T$. \ \only{\includegraphics[width=50mm]{slike/fig-1.png}}<1>
			 \item Nariši lok $k$ s središčem v $T$. \ \only{\includegraphics[width=50mm]{slike/fig-2.png}}<2>
			 \item Premico $p$ seče v točkah $A$ in $B$. \ \only{\includegraphics[width=50mm]{slike/fig-3.png}}<3>
			 \item Nariši lok $m$ s središčem v $A$. \ \only{\includegraphics[width=50mm]{slike/fig-4.png}}<4>
			 \item Nariši lok $n$ s središčem v $B$ in z enakim polmerom. \ \only{\includegraphics[width=50mm]{slike/fig-5.png}}<5>
			 \item Loka se sečeta v točki $C$. \ \only{\includegraphics[width=50mm]{slike/fig-6.png}}<6>
			 \item Premica skozi točki $T$ in $C$ je pravokotna na $p$. \ \only{\includegraphics[width=50mm]{slike/fig-7.png}}<7>
		  \end{itemize}
