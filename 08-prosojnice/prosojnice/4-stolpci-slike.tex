	...
	\begin{columns}[T] % Align top
		...
		\begin{column}{0.45\textwidth}
		  \begin{itemize}
			...
			%\item<2> \includegraphics[width=50mm]{slike/fig-2.png}
			%\item<3> \includegraphics[width=50mm]{slike/fig-3.png}
			%\item<4> \includegraphics[width=50mm]{slike/fig-4.png} 
			%\item<5> \includegraphics[width=50mm]{slike/fig-5.png} 
			%\item<6> \includegraphics[width=50mm]{slike/fig-6.png} 
			%\item<7> \includegraphics[width=50mm]{slike/fig-7.png} 
		  \end{itemize}
		\end{column}
	  \end{columns}
