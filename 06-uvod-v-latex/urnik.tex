...
kakovost urnika:
$$k_1 \cdot u_1 + k_1 \cdot u_2 + \dots + k_{n-1} \cdot u_{n-1} + k_n \cdot u_n$$
...
zato si je smiselno podrobneje ogledati posamezne korake.
   ...
   \begin{enumerate}
      ...
      $srecanja_i$, ki ga sestavlja $predmet_t$, profesor, ki ta predmet predava,
      ...
      vstavljanja, da bomo $predmet_t$ na koncu vstavili v termin z najboljšo
      ceno vstavljanja.
